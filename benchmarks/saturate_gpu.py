...
def main(args : argparse.Namespace):
    ...
    for gpu_idx in range (0,args.num_gpus):
        for proc_idx in range(0, proc_per_gpu):
            ...
            sp_args = ["python", benchmark_py_path, unity_binary_path, "-a", "VectorVisual", "--worker_id", str(proc_idx+(gpu_idx*proc_per_gpu))]
            print(sp_args)
...
if __name__ == '__main__':
    ...
    parser.add_argument('binary', metavar='B', type=Path, default="/mnt/AICOOP_binaries/Build2.4.4/Berlin_Walk_V2.x86_64", help="File path to Unity game binary")
    parser.add_argument('benchmarkpy', metavar='bench', type=Path, default="/mnt/ai_coop_py/benchmarks/benchmark.py", help="File path to benchmark.py")
    ...
    parser.add_argument('--timeout', default=30, type=int, help="Amount of time in seconds between process status checks")
