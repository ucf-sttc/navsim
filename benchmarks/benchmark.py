...
if __name__ == '__main__':
    ...
    parser.add_argument('binary', metavar='B', type=Path, help="File path to Unity game binary")
    ...
    parser.add_argument('--saveimages', action="store_true", help="Save images at every visual observations at every step")
